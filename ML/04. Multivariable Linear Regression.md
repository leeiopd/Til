...
* Tensorflow 구현
  ...
  * Multi-variable Linear Regression
    ...
    * 결과
    ...
    ![](imgs/04_multivariavle_linear_regression_result.png)
...
* Multi-variable Linear Regression - Matrix
  ...
  * Matrix 연산을 사용하여 계산
    ...
    * 결과
      ...
      ![](imgs/04_multivariavle_linear_regression_result_Matrix.png)]
...
* Lading Data From File
  ...
  * 결과
    ...
    ![](imgs/04_multivariable_linear_regression_ loading_data_from_file.png)
  ...
  * 학습된 hypothesis 사용하여 예측값 받아보기
    ...
    ![](imgs/04_multivariable_linear_regression_ loading_data_from_file_using_hypothesis.png)
